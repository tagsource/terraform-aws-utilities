...
module "pex_resource" {
  ...
  # source = "git::git@github.com:tagsource/package-terraform-utilities.git//modules/run-pex-as-resource?ref=v1.0.8"
...
module "pex_data" {
  # When using these modules in your own templates, you will need to use a Git URL with a ref attribute that pins you
  # to a specific version of the modules, such as the following example:
  # source = "git::git@github.com:tagsource/package-terraform-utilities.git//modules/run-pex-as-data-source?ref=v1.0.8"
